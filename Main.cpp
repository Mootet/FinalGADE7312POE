...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "GADEOPENGL", NULL, NULL);
	...
	//Generates Shader object for skybox using skybox.vert and .frag
	...
	// Sets the model data and textures
	 ...
	 Model chair2("Models/chair/scene.gltf");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		chair2.Draw(shaderProgram, camera);
